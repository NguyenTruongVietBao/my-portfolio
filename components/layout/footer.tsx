  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/NguyenTruongVietBao',
    },
    {
      name: 'LinkedIn',
      icon: <LinkedinIcon className='w-5 h-5' />,
      url: 'https://www.linkedin.com/in/nguy%E1%BB%85n-tr%C6%B0%C6%A1ng-vi%E1%BA%BFt-b%E1%BA%A3o-809374375/',
    },
    {
      name: 'Facebook',
      icon: <FacebookIcon className='w-5 h-5' />,
      url: 'https://www.facebook.com/nguyentruongvietbao/',
    },
  ];
        ...
        >
          ...
          <div className='space-y-4'>
            ...
            <p className='text-[#fffaf0]/80 text-lg leading-relaxed'>
              Fullstack Developer passionate about building modern web & mobile
