                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-5">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs text-black/60">Proficiency</span>
                    ...
                    {/* Technologies */}
                    <div>
                      <div className="text-xs font-medium text-black/70 mb-2">Technologies</div>
        ...
        >
          <div className="mx-auto grid max-w-4xl grid-cols-2 md:grid-cols-4 divide-x divide-black/[0.06] overflow-hidden rounded-xl ring-1 ring-black/[0.06] bg-white/60 backdrop-blur-md">
            <div className="px-6 py-5 text-center">
              <div className="text-3xl font-semibold text-black">{SKILLS.length}+</div>
              <div className="text-xs text-black/60">Technologies</div>
            </div>
            <div className="px-6 py-5 text-center">
              <div className="text-3xl font-semibold text-black">
                {Math.round(
                  SKILLS.reduce((acc, skill) => acc + skill.percentage, 0) / SKILLS.length
                )}
                %
              </div>
