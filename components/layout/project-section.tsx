...
const techIcons: { [key: string]: React.ReactNode } = {
  ...
  'Google Map API': <SiGooglemaps size={16} />,
  'Tanstack Query': <span className="text-xs font-bold">TQ</span>,
  FCM: <span className="text-xs font-bold">FCM</span>,
  PayOS: <span className="text-xs font-bold">PayOS</span>,
  Cloudinary: <SiCloudinary size={16} />,
  'Expo Secure Store': <SiExpo size={16} />,
  'Expo Camera': <SiExpo size={16} />,
  'MoMo E-wallet': <span className="text-xs font-bold">MoMo</span>,
};
      ...
      <div className="mx-auto">
        ...
        <div ref={cardsRef}>
          <div className="flex justify-center gap-4 mx-20">
            {PROJECTS.map((project, index) => (
              <div
                ...
                onClick={() => {
                  const url =
                    project.github?.frontend || project.github?.backend || project.github?.mobile;
          ...
          <div className="flex items-center justify-between mx-40 mt-24">
            <h2 className="text-3xl font-bold text-black">Other Projects</h2>
          </div>
        </div>
